...
import { View, Text, TouchableOpacity, TextInput, StyleSheet, Keyboard, KeyboardAvoidingView, ScrollView } from 'react-native';
import { useNavigation } from '@react-navigation/native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
import { faHome, faStar as faSolidStar, faEllipsisVertical, faPaperclip, faListCheck } from '@fortawesome/free-solid-svg-icons';
import { faStar as faRegularStar, faImage, faPenToSquare } from '@fortawesome/free-regular-svg-icons';
              ...
              <TouchableOpacity onPress={starIconPress}>
                <View style={styles.starIconContainer}>
                  {isPressed ? (
                    <FontAwesomeIcon
                      icon={faSolidStar}
                      style={styles.starIconSolid}
                      size={30}
                    />
                  ) : (
                    <FontAwesomeIcon
                      icon={faRegularStar}
                      style={styles.starIconOutline}
                      size={30}
                    />
                  )}
                </View>
